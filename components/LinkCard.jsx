...
export const LinkCard = ({ link, target, title, text, linkProps }) => {
  ...
  const containerClass = `${inter.className} h-full sm:max-w-full px-5 py-4 border border-gray-200 rounded-lg backdrop-blur-2xl text-white shadow bg-plum-600/90 dark:bg-navy-900/50 border-plum-700 dark:border-navy-700 dark:text-white transition-colors hover:bg-plum-300 hover:text-black hover:text-white dark:hover:bg-navy-900 dark:hover:text-white`
